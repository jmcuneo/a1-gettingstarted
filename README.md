...
1. (5 points) Style your page using CSS. Each style rule you apply will get you 1 point for a maximum of 5 points. Be sure to describe your style rules in your README. 
    1. I added a red to half purple gradient. I used these colors and gradient on my personal website. I made a color wheel for them but do not know how to use it.
    2. I changed margins to allow for the gradient
    3. I changed the font color to white
    4. I changed the font for my name and wpi
    5. I put the image behind the text using postion and z-indexes
...
1. (10 points) Create a color palette using [color.adobe.com](https://color.adobe.com). Use all the colors in the palette in your webpage by implementing the appropriate CSS. Add a small screenshot of the color wheel for your color palette to your repo.
    - not really sure how to make the color wheel "good" nor do I knwo how to use it. I just put the colors I already used.
2. (5 points) Use a font from [Google Fonts](https://fonts.google.com) in your website.
    - I added kings from google fonts. 
...
*Technical Achievements*
1. (5 points) Style your page using CSS. Each style rule you apply will get you 1 point for a maximum of 5 points. Be sure to describe your style rules in your README. 
    1. I added a red to half purple gradient. I use same these colors and gradient on my [personal website](https://gamestream.stream/resume). I made a color wheel for them but do not know how to use it.
    2. I changed margins and forced the body to be full size to allow for the gradient
    3. I changed the font color to white
    4. I changed the font for my name, wpi, and the british museum. plus I changed the default font to roboto - not sure if that was required.
    5. I put the image behind the text using postion and z-indexes
    6. I added twemoji so I could make the class year cool
...
3. (5 points) Experiment with other *semantic* HTML tags (links, images, tables, header, footer, etc.). Each extra tag you use will get you 1 point for a maximum of 5 points. Be sure to describe the tags you use in your README.
    ...
    2. I added a hyperlink to my website and to the british museum project using the \<a> tag
    3. I used a \<span> for the emoji numbers
    4. I used a \<table> to show classes I have taken
    5. I used a \<video> element to show a wonderful and wholesome video

*Design Achievements*
1. (10 points) Create a color palette using [color.adobe.com](https://color.adobe.com). Use all the colors in the palette in your webpage by implementing the appropriate CSS. Add a small screenshot of the color wheel for your color palette to your repo.
    - I made a color wheel using the webite. I am not really sure how to make the color wheel "good" nor do I know how to use it. I just put the colors I already used. I then used it as the bouncing image.
2. (5 points) Use a font from [Google Fonts](https://fonts.google.com) in your website.
    - I added kings from google fonts. 
    - Added roboto - dont think this was required, did it anyway
    - used serif - not from google fonts, but it is the font wpi uses I think
